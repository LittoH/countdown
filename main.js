...
// DATA DEBUG                        var countDownDate = new Date("Nov 26, 2020 01:50:30").getTime();
...
document.getElementById("demo").innerHTML = days + "g " + hours + "o "
+ minutes + "m " + seconds + "s ";

// If the count down is finished, write some text
if (distance < 0) {
    clearInterval(x);
    document.getElementById("demo").innerHTML = "Buon pensionamento!";
    hideSlider();
    startfireworks();
}
}, 1000);
